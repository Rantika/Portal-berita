<script src="{{('back/assets/js/core/jquery.3.2.1.min.js')}}"></script>
	<script src="{{('back/assets/js/core/popper.min.js')}}"></script>
	<script src="{{('back/assets/js/core/bootstrap.min.js')}}"></script>

	<!-- jQuery UI -->
	<script src="{{('back/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js')}}"></script>
	<script src="{{('back/assets/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js')}}"></script>
	...
	<!-- jQuery Vector Maps -->
	<script src="{{('back/assets/js/plugin/jqvmap/jquery.vmap.min.js')}}"></script>
	<script src="{{('back/assets/js/plugin/jqvmap/maps/jquery.vmap.world.js')}}"></script>

	<!-- Sweet Alert -->
	<script src="{{('back/assets/js/plugin/sweetalert/sweetalert.min.js')}}"></script>

	<!-- Atlantis JS -->
	<script src="{{('back/assets/js/atlantis.min.js')}}"></script>
