			...
			<div class="card full-height">
				<div class="card-header">
					<div class="card-head-row">
                        ...
                        <a href="{{route('materi.create')}}" class="btn btn-primary btn-sn ml-auto"><i class="fas fa-plus"></i>Tambah Materi</a>
					</div>
				</div>
				<div class="card-body">
                        ...
                        <table class="table table-borderd">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset('uploads/'.$row->gambar_materi)}}" width="100"> </td>
                                    <td>
