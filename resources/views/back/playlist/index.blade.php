			...
			<div class="card full-height">
				<div class="card-header">
					<div class="card-head-row">
                        ...
                        <a href="{{route('playlist.create')}}" class="btn btn-primary btn-sn ml-auto"><i class="fas fa-plus"></i>Tambah Playlist</a>
					</div>
				</div>
				<div class="card-body">
                        ...
                        <table class="table table-borderd">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset('uploads/'.$row->gambar_playlist)}}" width="100"> </td>
                                    <td>
